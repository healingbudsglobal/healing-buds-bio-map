  ...
  return (
    <div className="animate-fade-in flex flex-col items-center justify-center px-6 text-center">
      <div className="relative mb-8">
        ...
        <span className="absolute inset-0 flex items-center justify-center font-display text-xs font-bold tracking-widest text-primary">HB</span>
      </div>
      ...
      <p className="text-sm text-muted-foreground max-w-xs">
        Our algorithm is cross-referencing your bio-profile with our lab-tested strain inventory
      </p>
