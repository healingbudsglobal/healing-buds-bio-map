  ...
  return (
    <div className="animate-scale-in relative z-10 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="relative mb-8">
        <div className="absolute inset-0 h-24 w-24 rounded-full bg-[hsl(var(--brand-gold)_/_0.08)]" style={{ animation: 'ping 2s cubic-bezier(0, 0, 0.2, 1) infinite' }} />
        <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-[hsl(var(--brand-gold)_/_0.1)] border border-[hsl(var(--brand-gold)_/_0.25)] shadow-[var(--shadow-glow-gold)]">
          <CheckCircle className="h-12 w-12 text-[hsl(var(--brand-gold))]" />
        </div>
      </div>
      ...
      <button
        ...
        className="mt-8 inline-flex items-center gap-2 rounded-xl border border-border px-6 py-3 text-sm font-medium text-muted-foreground transition-all hover:border-[hsl(var(--brand-gold)_/_0.5)] hover:text-foreground"
      >
